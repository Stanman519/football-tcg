...
namespace TcgEngine
{
    ...
    public class Game
    {
        ...
        //Game state
        public int first_offense_player = 0;
        public int current_offsense_player = 0;
...
/*                if (!slot.IsValid())
        ...
        {
            return GetPlayer(current_offsense_player);
        }
...
/*        public void AdjustBallPosition(int yardsGained)
        ...
        public static void Clone(Game source, Game dest)
        {
            ...
            dest.first_offense_player = source.first_offense_player;
            dest.current_offsense_player = source.current_offsense_player;
