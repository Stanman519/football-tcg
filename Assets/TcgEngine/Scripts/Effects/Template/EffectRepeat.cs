...
namespace TcgEngine
{
    ...
    public class EffectRepeat : EffectData
    {
        ...
        public override void DoEffect(GameLogicService logic, AbilityData iability, Card caster)
        {
        ...
        public override void DoEffect(GameLogicService logic, AbilityData iability, Card caster, Player target)
        {
            int count = GetRepeatCount(logic.GameData, iability);
            for (int i = 0; i < count; i++)
            {
        ...
        public override void DoEffect(GameLogicService logic, AbilityData iability, Card caster, Card target)
        {
            int count = GetRepeatCount(logic.GameData, iability);
            for (int i = 0; i < count; i++)
            {
