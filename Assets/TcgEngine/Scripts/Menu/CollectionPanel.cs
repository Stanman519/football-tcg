    ...
    public class CollectionPanel : UIPanel
    {
        ...
        public void RefreshCards()
        {
            ...
            if (filter_dropdown == 1) //Attack
                all_cards.Sort((CardDataQ a, CardDataQ b) => { return b.card.attack == a.card.attack ? b.card.stamina.CompareTo(a.card.stamina) : b.card.attack.CompareTo(a.card.attack); });
            if (filter_dropdown == 2) //hp
                all_cards.Sort((CardDataQ a, CardDataQ b) => { return b.card.stamina == a.card.stamina ? b.card.attack.CompareTo(a.card.attack) : b.card.stamina.CompareTo(a.card.stamina); });
